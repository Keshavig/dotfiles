...
(setq user-full-name "Keshav Bhatta"
      user-mail-address "keshavbhatta222@gmail.com")
...
;; - `doom-serif-font' -- for the `fixed-pitch-serif' fae
;;
...
(setq default-directory "C:/Users/kesha/Code/")
...
;;(add-to-list 'custom-theme-load-path "C:\Users\kesha\AppData\Roaming\.emacs.d\themes")
;;(load-theme 'less-theme t)
